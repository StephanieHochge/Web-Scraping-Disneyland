...
class TestScraping:
    ...
    def test_weather_scraping(self):
        ...
        # scrape the three weather forecasts (forecasts for today, tomorrow and in seven days)
    ...
    def test_wait_time_scraping(self):
        ...
        for i in range(3):
            ...
            # wait for three seconds before carrying out the next scrape iteration
            time.sleep(3)
        ...
        for site in websites:
            ...
            # test transfer from csv to HDF5 file by checking whether the HDF5 files have the expected shapes
